...
<examples>
  <example>
    ...
    <output>
Composite 2/10 on headline claim; findings and roadmap saved under docs/.
    </output>
  </example>
</examples>
...
| Excuse | Reality |
|--------|---------|
| "Sounds plausible" | Evidence tiers and source quality required for claims |
| "One search confirms it" | Triangulate; note confidence and falsifiers |
| "Defer hard claims" | Mark unverified explicitly; no assumptions as facts |
| "Eval replaces reality-check" | eval-output judges artifacts; this skill checks factual claims |

## Verification

- [ ] Each claim tagged with evidence tier and confidence
- [ ] Sources cited with quality assessment
- [ ] Unverified items explicitly marked
- [ ] Falsifiers or what would change the verdict documented
