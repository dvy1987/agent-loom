...
**Exception: `secure-skill` must never be compressed.** If secure-skill exceeds 180 lines, invoke `split-skill` instead. Compression removes threat coverage — not acceptable for security skills.
