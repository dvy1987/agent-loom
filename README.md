...
| [`deep-thinking`](.agents/skills/deep-thinking/) | Orchestrator — diagnoses which framework(s) fit your problem and guides you through them in the right sequence. Entry point for any deep reasoning need. | No files. Multi-framework session with synthesis and concrete next action. | "deep thinking", "help me think through this properly", "what thinking tool should I use" |
