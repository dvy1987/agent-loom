...
Today the library contains **98 skills** across thinking, project lifecycle, evaluation, security, memory, frontend, and meta layers — kept in sync by `library-skill` on every create / split / deprecate / structural improvement.
